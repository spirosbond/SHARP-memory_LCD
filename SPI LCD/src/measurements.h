...
// ADC configuration
#define ADC_FREQ			10000	//Frequency
#define ADC_GAIN			1		//Gain
#define ADC_RESULT_MAX		2047.0	//Maximum result 2^11
#define ADC_REF_VOLTAGE		1.0		//Reference voltage
#define ADC_DEFAULT_OSMPL	32.0	//Default oversampling
#define ADC_LOW_OSMPL		8.0		//Low oversampling
#define ADC_HIGH_OSMPL		128.0	//High oversampling
